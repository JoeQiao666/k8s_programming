...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(cloudstate.GroupVersion,
		&cloudstate.StatefulStore{},
		&cloudstate.StatefulStoreList{},
	)
	meta_v1.AddToGroupVersion(scheme, cloudstate.GroupVersion)
	return nil
}

func NewClient(cfg *rest.Config) (*StatefulstoreClient, error) {
	...
	return &StatefulstoreClient{restClient: client}, nil
}
